...
export const getIonPageElement = (element: HTMLElement) => {
    ...
    if (ionPage) {
        return ionPage; // return the original element so at least something animates and we don't have a null pointer
    }
    return element;
};

export const navigation = (_: HTMLElement, opts: any) => {
